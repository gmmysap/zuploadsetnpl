		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "NPL UploadSet",
									"targetURL": "#zuploadsetnpl-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zuploadsetnpl-display": {
								"semanticObject": "zuploadsetnpl",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zuploadsetnpl",
									"url": sap.ui.require.toUrl("zuploadsetnpl")
								}
							}
						}
					}
