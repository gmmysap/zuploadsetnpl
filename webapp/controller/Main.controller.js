            ...
            onBeforeUploadStarts: function (oEvent) {
               ...
               oUploadSet.removeAllHeaderFields();
                oUploadSet.addHeaderField(
                    new sap.ui.core.Item({
                        key: "slug",
                        text: oEvent.getParameter('item').mProperties.fileName
                    })
                );
              ...
              */
                ...
                var oCustomerHeaderSlug = {
                    name: "slug",
                    value: oEvent.getParameter('item').mProperties.fileName
                };
                //oEvent.getParameters().addHeaderParameter(oCustomerHeaderSlug);

                var oModel = this.getView().getModel();

                oModel.setHeaders(oCustomerHeaderSlug);
                ...
                oModel.setHeaders(oCustomerHeaderToken);
